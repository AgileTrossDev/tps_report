...
class TestConsumerDbClient(unittest.TestCase):
    ...
    def test_handle_interrupt(self):
      ...
      # Instead, we can mock the sys.stdout object and check if the correct message is printed
      with patch("builtins.print") as mock_print:
        ...
        # Get the last call to the mock print function, and make surer it says it was Interrupted
    ...
    def test_process_msg(self):
        ...
        # Assert that the write method of the mock write_api was called with the correct arguments
...
async def test_capture_data(mocker):
    ...
    mock_connect_function = mocker.patch.object(ConsumerDbClient, 'connect', return_value="Patched Result")
  
    # Create an instance of ConsumerDbClient, while using mocked connect function
    client = ConsumerDbClient()
    assert client.active is True
    ...
    # Set the return value of mock_websockets_connect to the mock WebSocket connection
